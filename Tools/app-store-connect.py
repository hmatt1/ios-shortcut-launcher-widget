...
DESCRIPTION = """Shortcut Launcher Widget turns your Home Screen into a highly customizable launchpad for the Shortcuts you already have.

Pick up to 64 shortcuts and they become a beautiful grid of named tiles. Tap one and it runs right there in place. Nothing opens. This app is all about letting you build the exact widget you want.
